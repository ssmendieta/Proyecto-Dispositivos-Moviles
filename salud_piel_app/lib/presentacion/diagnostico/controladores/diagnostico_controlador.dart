    ...
    switch (condicion) {
      case CondicionPiel.acne:
        return InformacionCondicion(
          descripcion: 'El acné es una afección cutánea que ocurre cuando los folículos pilosos se obstruyen con sebo y células muertas, formando comedones, pápulas, pústulas o quistes. Es más común en la adolescencia pero puede persistir en la edad adulta.',
          causas: [
          ...
          recomendacionDermatologo: 'Si el acné es persistente, causa cicatrices o afecta tu autoestima, acude a un dermatólogo. Señales de alerta: quistes profundos y dolorosos, acné que no mejora con cuidados básicos o que deja marcas oscuras.',
          consejosCuidado: [
      ...
      case CondicionPiel.eczema:
        return InformacionCondicion(
          descripcion: 'El eczema (dermatitis atópica) es una inflamación crónica de la piel que causa enrojecimiento, picazón intensa, sequedad y descamación. Suele aparecer en parches y puede afectar cualquier parte del cuerpo.',
          causas: [
          ...
          recomendacionDermatologo: 'Consulta a un dermatólogo si la picazón interrumpe tu sueño, si hay signos de infección (costras amarillas, pus, fiebre) o si el eczema afecta gran parte del cuerpo. El tratamiento temprano previene complicaciones.',
          consejosCuidado: [
      ...
      case CondicionPiel.rosacea:
        return InformacionCondicion(
          descripcion: 'La rosácea es una afección crónica que causa enrojecimiento facial, vasos sanguíneos visibles y, en algunos casos, pápulas y pústulas similares al acné. Afecta principalmente la parte central del rostro: mejillas, nariz, frente y barbilla.',
          causas: [
          ...
          recomendacionDermatologo: 'La rosácea no tiene cura pero requiere tratamiento dermatológico para controlarla. Acude si notas enrojecimiento persistente, brotes frecuentes o si los vasos sanguíneos se vuelven cada vez más visibles. El tratamiento incluye cremas, láser y antibióticos.',
          consejosCuidado: [
      ...
      case CondicionPiel.melasma:
        return InformacionCondicion(
          descripcion: 'El melasma es una condición que causa manchas oscuras o hiperpigmentación en la piel, generalmente en el rostro. Aparece como parches simétricos de color marrón o grisáceo en mejillas, frente, nariz y labio superior.',
          causas: [
          ...
          recomendacionDermatologo: 'El melasma puede ser resistente al tratamiento. Consulta a un dermatólogo si las manchas se oscurecen, se extienden o no mejoran con protección solar. Existen tratamientos con hidroquinona, ácido kójico, peelings y láser.',
          consejosCuidado: [
      ...
      case CondicionPiel.psoriasis:
        return InformacionCondicion(
          descripcion: 'La psoriasis es una enfermedad autoinmune crónica que acelera el ciclo de vida de las células de la piel, causando acumulación de células en la superficie. Esto produce placas gruesas, rojizas y escamosas que pueden ser dolorosas o causar picazón.',
          causas: [
          ...
          recomendacionDermatologo: 'La psoriasis requiere atención dermatológica especializada. Acude si las placas cubren áreas extensas, si hay dolor en las articulaciones (posible artritis psoriásica) o si afecta tu calidad de vida. Existen tratamientos tópicos, sistémicos y biológicos.',
          consejosCuidado: [
      ...
      case CondicionPiel.dermatitis:
        return InformacionCondicion(
          descripcion: 'La dermatitis es un término general que describe la inflamación de la piel. Se manifiesta con enrojecimiento, picazón, hinchazón y, en algunos casos, ampollas o descamación. Puede ser causada por contacto con irritantes, alérgenos o por predisposición genética.',
          causas: [
          ...
          recomendacionDermatologo: 'Consulta a un dermatólogo si la dermatitis es extensa, muy dolorosa, o si hay signos de infección (pus, fiebre, costras amarillas). Un especialista puede realizar pruebas de parche para identificar alérgenos específicos.',
          consejosCuidado: [
      ...
      case CondicionPiel.normal:
        return InformacionCondicion(
          descripcion: 'Tu piel se encuentra en buen estado, sin condiciones visibles detectadas. La piel normal tiene un equilibrio adecuado de hidratación y producción de sebo, sin irritaciones ni lesiones aparentes.',
          causas: [
          ...
          recomendacionDermatologo: 'Si no tienes molestias ni cambios en tu piel, basta con mantener una rutina básica: limpieza suave, hidratación y protector solar a diario. Realiza autoexámenes periódicos y consulta si notas cambios repentinos.',
          consejosCuidado: [
      ...
      case CondicionPiel.otro:
        return InformacionCondicion(
          descripcion: 'Se ha detectado una condición cutánea que requiere atención. Las condiciones de la piel pueden variar ampliamente en sus causas, síntomas y tratamientos.',
          causas: [
          ...
          recomendacionDermatologo: 'Se recomienda consultar a un dermatólogo para obtener un diagnóstico preciso. No automediques ni uses tratamientos sin supervisión profesional, especialmente si hay dolor, picazón intensa o signos de infección.',
          consejosCuidado: [
